...
namespace SAS.TweenManagement
{
    public static class Extensions
    {
        ...
        public static void SetRotation(this Transform transform, Quaternion angle)
        {
            transform.rotation = angle;
        }

        public static void SetLocalRotation(this Transform transform, Quaternion angle)
        {
            transform.localRotation = angle;
        }

        public static void SetEulerAngles(this Transform transform, Vector3 angle)
        {
            transform.eulerAngles = angle;
        }

        public static void SetLocalEulerAngles(this Transform transform, Vector3 angle)
        {
        ...
        public static void SetAlpha(this CanvasGroup canvasGroup, float val)
        {
        ...
        public static void SetAlpha(this Renderer renderer, float val)
        {
            ...
            {
                UnityEngine.Color temp = renderer.material.color;
                temp.a = val;
